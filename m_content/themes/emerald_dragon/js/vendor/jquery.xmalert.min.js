    ...
    s.fn.xmalert = function (e) {
        ...
        var a, i, n, o = {},
            ...
            d = function (t) {
                ...
                switch (t) {
                case "item":
                    e.addClass("item").append('<figure class="user-avatar">								<img src="' + o.settings.imgSrc + '" alt="user-image">						     </figure>    						 <p class="info">' + o.settings.title + '</p>    						 <p class="timestamp">' + o.settings.timestamp + '</p>    						 <span class="sl-icon ' + o.settings.iconClass + '"></span>    						 <img class="close-btn" src="'+'<?php echo get_theme_path($themes); ?>'+'images/dashboard/notif-close-icon.png" alt="close-icon">						');
                    break;
                case "messageInfo":
